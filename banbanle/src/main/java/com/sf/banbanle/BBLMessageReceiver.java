...
/**
 * Created by NetEase on 2016/12/2 0002.
 */
...
public class BBLMessageReceiver extends PushMessageReceiver {
    /**
     * TAG to Log
     */
    public static final String TAG = BBLMessageReceiver.class
            .getSimpleName();
    ...
    private void updateContent(Context context, String content) {
        L.info(TAG, "updateContent: " + content);
